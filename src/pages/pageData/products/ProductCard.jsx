...
const ProductCard = () => {
  return (
    <div className='lg:max-w-[1380px] max-w-[304px] sm:mx-auto'>
     <ul className='grid grid-cols-3 grid-rows-5 lg:grid-cols-5 lg:grid-rows-5  lg:gap-y-[97px] lg:gap-x-[20px] gap-x-[10px] gap-y-[26px]  lg:ml-[125px] lg:mt-[60px] ml-[17px] mt-[20px]'>
  ...
  >
                <div className=' lg:max-w-[235px] '>{val.img}
                    ...
                    <Icon icon='material-symbols:favorite-outline' className="lg:text-[24px] lg:ml-12 mt-[0.5px] ml-[20px]  text-[#F79E1B] font-bold text-[7px]"/>
                            ...
                            <div>
                            <p className='text-[7px] font-semibold lg:text-[16px] lg:mb-[12px] lg:mt-[17px] mb-[7.61px] mt-[4px]'>{val.price}</p>
                         </div>
                   
                    <div className='lg:mt-[2px] sm:flex -mt-[8px]'>
                    <Link to="/cart">
