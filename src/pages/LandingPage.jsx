...
const LandingPage = () => {
  return (
    <>
    <div className="sm:mx-auto lg:max-w-[1540px] lg:max-h-[3768px] ">
        ...
        <div className="    mt-[23px] mb-[23px] ml-[17px] lg:ml-[125px] lg:mt-[86px] lg:mb-[20px]">
          ...
          <div className=" text-[20px] font-semibold  lg:font-medium lg:text-[36px]">
            ...
            <div className="sm:mx-auto sm  max-w-[375px] max-h-[220px]">
           ...
           <div className="">
            <ProductCard/>
            <div>
        <footer className="mx-auto md:mx-auto max-w-[369px] max-h[178px] lg:max-w-[1512px] lg:max-h-[411px] mt-[20px] lg:flex lg:-mt-[400px] lg:mb-[0px]">
